...
export function StrategyHeader() {
  ...
  return (
    <div className="flex gap-3">
      <div className="bg-ocean-600 flex min-h-[80px] w-full justify-between rounded-2xl px-6 ">
        <MarketList />
      ...
      <div className="bg-ocean-600 flex min-h-[80px] w-[44%] justify-around rounded-2xl ">
        <ItemInfo
          info={'sUSD'}
