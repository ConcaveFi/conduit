  ...
  return (
    ...
    >
      <div className="flex max-h-full flex-1 flex-col">
        {/* Skew */}
        <div className="bg-ocean-500 centered flex py-3 w-full flex-col gap-1 rounded-b-xl px-4 ">
          <div className="flex w-full justify-between text-sm">
            <span className="text-positive text-xs">53%</span>
            <span className="text-white text-xs">Skew</span>
        ...
        <div className="flex w-full flex-col overflow-auto p-4">
          <Table className="text-end">
            <thead>
              ...
              <tr className="text-ocean-200 text-xs border-b-2 border-ocean-900">
