export const FUTURES_MARKER_ABI = [
  {
    inputs: [
  ...
  {
    constant: false,
    inputs: [{ internalType: 'bytes32', name: 'trackingCode', type: 'bytes32' }],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'fee', type: 'uint256' },
      { internalType: 'enum IFuturesMarketBaseTypes.Status', name: 'status', type: 'uint8' },
    ],
    payable: false,
    stateMutability: 'view',
    type: 'function',
